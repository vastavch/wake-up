...
/*The instance of this class is called by "MainActivty",to get the time taken reach the destination from Google Distance Matrix API in background.
  This class contains interface "Geo" to call the function setDouble(Double) defined in "MainActivity,class" to display the time.*/
public class GeoTask extends AsyncTask<String,Void,Double> {
    ProgressDialog pd;
    Context mContext;
    Double duration;
    Geo geo1;
    ...
    protected Double doInBackground(String... params) {
        try {
            ...
            if(statuscode==HttpURLConnection.HTTP_OK)
            {
                ...
                return Double.parseDouble(object_duration.getString("value"));
